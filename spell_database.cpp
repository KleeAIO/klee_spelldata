		...
		std::map<champion_id, std::vector<spell_data>> data =
		{
			...
			},
			{
				champion_id::Anivia,
				{
					...
					spell_data{"E", {"Frostbice"}, spellslot::e, true, false, false, {}, {damage_type::magical}, skillshot_type::skillshot_line , 0.25f, 1600.0f},
			...
			},
			{
				champion_id::Evelynn,
				{
					...
					//?spell_data{"W", {""}, spellslot::w, false, true, false, {}, {damage_type::physical}, skillshot_type::skillshot_line , 0.25f, FLT_MAX},
			...
			},
			{
				champion_id::Ornn,
				{
					...
					//?spell_data{"W", {"OrnnW"}, spellslot::w, false, true, false, {buff_type::Knockup}, {damage_type::magical}, skillshot_type::skillshot_line , 0.25f, FLT_MAX},
			...
			},
			{
				champion_id::Rammus,
				{
					...
					//?spell_data{"R", {"Tremors2"}, spellslot::r, false, true, false, {}, {damage_type::physical}, skillshot_type::skillshot_line , 0.25f, FLT_MAX},
				}
			},
			{
				champion_id::RekSai,
